...
[![Linux](https://img.shields.io/circleci/project/github/conda-forge/r-nada-feedstock/master.svg?label=Linux)](https://circleci.com/gh/conda-forge/r-nada-feedstock)
[![OSX](https://img.shields.io/travis/conda-forge/r-nada-feedstock/master.svg?label=macOS)](https://travis-ci.org/conda-forge/r-nada-feedstock)
[![Windows](https://img.shields.io/appveyor/ci/conda-forge/r-nada-feedstock/master.svg?label=Windows)](https://ci.appveyor.com/project/conda-forge/r-nada-feedstock/branch/master)
...
Once the `conda-forge` channel has been enabled, `r-nada` can be installed with:

```
conda install r-nada
```

It is possible to list all of the versions of `r-nada` available on your platform with:
